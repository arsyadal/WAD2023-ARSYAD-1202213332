...
Route::resource('/showroom/create', \App\Http\Controllers\ShowroomController::class);
Route::resource('/showroom/store', \App\Http\Controllers\ShowroomController::class);
